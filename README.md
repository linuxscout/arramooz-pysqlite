...
normalized|normalized word, unified hamza forms|كلمة منمّطة، الهمزات موحّدة
stamped|stamped word (all affixation letters are removed)|بصمة الكلمة، حروف الزيادة محذوفة، تستعمل للبحث عن الكلمات المتشابهة
...
```sql
CREATE TABLE `nouns` ( `id` int(11) unique,
