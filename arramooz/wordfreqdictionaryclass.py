...
class WordFreqDictionary:
    ...
    def __init__(self, table_name, attrib_index=WORDFREQ_DICTIONARY_INDEX, key_attribute = 'unvocalized'):
        """
        ...
        if os.path.exists(file_path):
            ...
            try:
                self.db_connect  =  sqlite.connect(file_uri, uri=True, check_same_thread=False,)
            except IOError:
